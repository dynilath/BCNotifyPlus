export const EN = new Map<string, string>([
  ...
  [
    "online_notify_add_hint",
    "Add player with this member number to the notify list.",
  ],
  ...
  ["online_notify_setting_col_online", "Online?"],
  ["online_notify_setting_col_offline", "Offline?"],
]);
